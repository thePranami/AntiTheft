        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Femail.isEmpty()|| Fmobile.isEmpty()){
                    Toast.makeText(ForgetPassword.this, "Please fill email and mobile", Toast.LENGTH_SHORT).show();
                }
                    ...
                    smsManager.sendTextMessage(Fmobile, null, "Your OTP is: " + generatedOTP[0]+"\n Please do not share this anyone else.", null, null);
                    ...
                    Toast.makeText(ForgetPassword.this, "Email or Mobile does not exist", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        changePassButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newPass.isEmpty() || conNewPass.isEmpty()){
                    Toast.makeText(ForgetPassword.this, "Fill password field", Toast.LENGTH_SHORT).show();
                }
                    ...
                    editor.commit();
                    Toast.makeText(ForgetPassword.this, "Password has been changed successfully", Toast.LENGTH_SHORT).show();
